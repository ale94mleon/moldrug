...
if TypeOfTest == 'single_receptor':
    ...
    out = ga.GA(
        ...
        costfunc_kwargs = {
            'receptor_path': [f'/home/ale/GITLAB/lead/data/{r}.pdbqt' for r in receptor],
    ...
    for o in out.pop:
        print(o.smiles, o.cost)
    out.pickle(f"/home/ale/GITLAB/lead/pkl/desirability_{'_'.join([r for r in receptor])}_NumGen_{out.NumGen}_PopSize_{popsize}", compress=True)
    print(out.to_dataframe())
